            ...
            <div className="container">
                <div className="d-flex align-center flex-column">
                    <div className="col-L">
                        ...
                        <h1>404</h1>
                        <h2>Esta pagina no existe o fue removida.</h2>
                        <hr />
                        <p>Podria ser un error nuestro, vuelve a esta pagina mas tarde e intentalo de nuevo. <br /><br /> Tu equipo Apps for the World.</p>
                    </div>
                    <div className="col-R">
