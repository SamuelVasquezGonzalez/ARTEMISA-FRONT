...
import ArteIcon from '../../assets/general-assets/complete-logo.png'

const InMaintenance: React.FC = () => {
    return (
                ...
                <div className="d-flex align-center flex-column">
                    <div className="col-L">
                        <div className="apps-icon">
                            <img src={ArteIcon} alt="" />
                        </div>
                        <h1>Mantenimiento</h1>
                        <h2>Estamos realizando un mantenimiento.</h2>
                        <hr />
                        <p>No tardaremos mucho, esto lo hacemos con darte una mejor experiencia. <br /><br /> Tu equipo Artemisa.</p>
                    </div>
                    <div className="col-R">
